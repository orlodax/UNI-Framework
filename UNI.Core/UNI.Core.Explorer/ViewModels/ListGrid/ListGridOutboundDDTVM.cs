...
{
    public class ListGridOutboundDDTVM<T> : ListGridVM<OutboundDDT>
    {
        public ListGridOutboundDDTVM()
        {
        ...
        protected override async Task LoadData(List<FilterExpression> filterExpressions = null, object parameter = null)
        {
            ...
            ItemsSource = new System.Collections.ObjectModel.ObservableCollection<OutboundDDT>(ItemsSource.OrderByDescending(i => i.Number));
        }
    }
}
