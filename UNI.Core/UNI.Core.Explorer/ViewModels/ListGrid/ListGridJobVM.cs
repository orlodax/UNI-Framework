...
{
    public class ListGridJobVM<T> //: ListGridVM<Job>
    {
        public ListGridJobVM()
        {
        ...
        //    ItemsSource = new System.Collections.ObjectModel.ObservableCollection<Job>(ItemsSource.OrderByDescending(i => i.DatePlanned));
